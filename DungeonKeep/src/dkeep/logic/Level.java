...
public abstract class Level implements java.io.Serializable {
	...
	/**
	 * Enumeration containing all the possibilities of the game cycle update
	 * output
	 *
	 */
	public enum State {
	 ...
	 * 
	 * @param row
	 *            Hero Position on the Horizontal Axis
	 * @param col
	 *            Hero Position on the Vertical Axis
	 * @return State of the game cycle after all the processing of the game
	 *         variables.
	 */
	...
	/**
	 * Function returning the next Level when the Hero reaches the victory
	 * position.
	 * 
	 ...
	 * 
	 * @param map
	 *            Matrix of chars containing a visual copy of the gameMap
	 */
