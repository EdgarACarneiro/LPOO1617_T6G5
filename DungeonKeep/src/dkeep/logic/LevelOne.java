...
public class LevelOne extends Level implements java.io.Serializable {
	...
	/**
	 * Default Constructor. Sets enemies active. Sets gameMap as a default
	 * DungeonMap. Sets Hero Position to the DungeonMap's hero position. Adds a
	 * single Guard, as a enemy, at the DungeonMaps' guard position.
	 */
	public LevelOne() {
	...
	/**
	 * Level One Constructor: Constructor from a map, it's victory positions and
	 * the enemies activity. Calls a superclass constructor.
	 * 
	 * @param map
	...
	/**
	 * Level's One Constructor: Sets enemies active. Sets gameMap as a default
	 * DungeonMap. Sets Hero Position to the DungeonMap's hero position. Adds a
	 * single Guard, as a enemy, at the DungeonMaps' guard position, with
	 * Personality gp.
	 * 
	 * @param gp.
	 *            Level One gurad's personality.
	 */
