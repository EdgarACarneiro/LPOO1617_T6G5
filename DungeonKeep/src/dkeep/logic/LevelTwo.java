...
public class LevelTwo extends Level implements java.io.Serializable {
	...
	/**
	 * Default Constructor: Set enemies active. Sets game Map as a new Ogre Map.
	 * Sets Hero Position to the OgreMap's hero position. Adds a random number
	 * of ogres, as enemies, at the OgreMap's enemies position.
	 */
	public LevelTwo() {
	...
	/**
	 * Level Two Constructor: Constructor from a map, it's victory positions ,
	...
	/**
	 * Level Two Constructor: Sets enemies active. Sets gameMap as a default
	 * OgreMap. Sets Hero Position to the DungeonMap's hero position. Adds
	 * numOgres number of Ogres, as enemies, at the OgreMap's enemy position.
	 *
	 * @param numOgres.
	 *            Level Two number of Ogres.
	 */
	...
	/**
	 * @return next Level, but in this case there is no next Level.
	 * 
